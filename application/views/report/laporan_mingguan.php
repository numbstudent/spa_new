                ...
                <tbody>
                  ...
                  foreach ($query as $row) {
                    ...
                    <tr>
                      ...
                      <td><?php echo $row->nama_supplier.'('.$row->item.')';?></td>
                      <td><?php echo (is_null($row->penjualan)?'':number_format($row->penjualan,2,",","."));?></td>
                      <?php $saldo += $row->penjualan;?>
                      <td><?php echo (is_null($row->pembelian)?'':number_format($row->pembelian,2,",","."));?></td>
                      <?php $saldo -= $row->pembelian;?>
                    </tr>
                    <?php
                    $no++;
                  }
